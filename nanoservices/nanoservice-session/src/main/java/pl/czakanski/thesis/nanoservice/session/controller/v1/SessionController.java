package pl.czakanski.thesis.nanoservice.session.controller.v1;
...
public class SessionController {
    ...
    public ResponseEntity<String> login(@RequestBody final LoginRequest request) {
        ...
        try {
            user = restTemplate.postForEntity(new URI(NanoserviceConstant.USER_SERVICE + ConstantRequest.USER + ConstantRequest.USER_AUTHENTICATED), request, User.class);
