package pl.czakanski.thesis.nanoservice.message.controller.v1;
...
public class MessageController {
    ...
    private Integer getUserId(ClientRequest request) {
        ...
        try {
            result = restTemplate.postForEntity(new URI(NanoserviceConstant.SESSION_SERVICE + ConstantRequest.SESSION + ConstantRequest.SESSION_REQUEST), request, Session.class);
        } catch (URISyntaxException e) {
            return null;
        }
